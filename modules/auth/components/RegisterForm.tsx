...
export default function RegisterForm() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res?.ok) {
        ...
        setError(res?.error || "Помилка реєстрації. Спробуйте ще раз.");
      }
    } catch (err: any) {
  ...
  return (
    <div>
      <h1 className="text-xl font-semibold mb-2">Реєстрація</h1>
      <p className="mb-6 text-sm text-neutral-400">Створіть новий акаунт</p>
      {error && (
